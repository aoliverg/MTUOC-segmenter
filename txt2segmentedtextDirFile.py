...
parser.add_argument("-o", "--output_file", type=str, help="The output dir to save the segmented files. If it doesn't exist, it will be created", required=True)
...
parser.add_argument("-p","--paragraph", action="store_true", help="Add the <p> pararaph mark", required=False, default=False)
...
if not srxlang in available_languages:
    print("ERROR: language "+srxlang+" not available in "+srxfile+". Available languages: "+", ".join(available_languages))
    sys.exit()
