...
def select_output_directory():
    outdir = askdirectory(initialdir = ".",mustexist=False, title = "Choose the output directory.")
    E2.delete(0,END)
    E2.insert(0,outdir)
    E2.xview_moveto(1)
...
top = Tk()
top.title("txt2segmentedtextDirDir_GUI")
...
B2=tkinter.Button(top, text = str("Output dir"), borderwidth = 1, command=select_output_directory,width=14).grid(row=1,column=0)
